package alternativa.engine3d.animation {
	...
	public class Animation {
		 ...
		 * Анимируемый объект.
		 */
		public var object:Transform3D = null;
		 ...
		 */
		public function Animation(object:Transform3D = null, weight:Number = 1.0, speed:Number = 1.0) {
			this.object = object;
			this.weight = weight;
			this.speed = speed;
		}
		...
		/**
		 * Переносит анимацию на указанный объект.
		 */
		public function reassign(object:Transform3D):void {
			this.object = object;
		}
