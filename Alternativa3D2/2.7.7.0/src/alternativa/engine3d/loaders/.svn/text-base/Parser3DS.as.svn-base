package alternativa.engine3d.loaders {
	...
	/**
	 * Парсер файлов формата <code>.3ds</code>, предоставленных в виде <code>ByteArray</code>.
	 */
	public class Parser3DS {
		...
		/**
		 * Список объектов, полученных в результате распарсивания.
		 * @see alternativa.engine3d.core.Object3D
		 */
		public var objects:Vector.<Object3D>;
		
		/**
		 * Список объектов, являющихся родительскими для объектов, полученных в результате распарсивания.
		 * С помощью этих объектов можно восстановить иерархию.
		 * @see alternativa.engine3d.core.Object3D
		 */
		public var parents:Vector.<Object3D>;
		
		/**
		 * Список всех материалов объектов, полученных в результате распарсивания.
		 * @see alternativa.engine3d.materials.Material
		 */
		public var materials:Vector.<Material>;
		
		/**
		 * Список всех текстурных материалов объектов, полученных в результате распарсивания.
		 * Для загрузки текстур материалов можно использовать <code>MaterialLoader</code>.
		 * Во время распарсивания свойствам текстурных материалов <code>diffuseMapURL</code> и <code>opacityMapURL</code> устанавливаются строковые значения, состоящие из <code>texturesBaseURL</code> и имени файла.
		...
		/**
		 * Выполняет парсинг.
		 * Результаты распарсивания находятся в списках <code>objects</code>, <code>parents</code>, <code>materials</code> и <code>textureMaterials</code>.
		 * @param data Файл в формате <code>.3ds</code>, предоставленный в виде <code>ByteArray</code>.
		 * @param texturesBaseURL Базовый путь к файлам текстур. Во время распарсивания свойствам текстурных материалов <code>diffuseMapURL</code> и <code>opacityMapURL</code> устанавливаются строковые значения, состоящие из <code>texturesBaseURL</code> и имени файла.
