package alternativa.engine3d.core {
	...
	public class Scene3D {
		...
		protected var operations:Array = new Array();
		//protected var operationSort:Array = ["priority", "level"];
		//protected var operationSortOptions:Array = [Array.NUMERIC, Array.NUMERIC];
		// Вспомогательная пустая операция, используется при удалении операций из списка
		protected var dummyOperation:Operation = new Operation("removed", this);
		
		// Флаг анализа сплиттеров
		protected var _splitAnalysis:Boolean = true;
		// Cбалансированность дерева
		protected var _splitBalance:Number = 0;
		/**
		 * @private
		...
		protected var addSort:Array = ["mobility"];
		protected var addSortOptions:Array = [Array.NUMERIC | Array.DESCENDING];
		protected var addSplitQualitySort:Array = ["mobility", "splitQuality"];
		protected var addSplitQualitySortOptions:Array = [Array.NUMERIC | Array.DESCENDING, Array.NUMERIC | Array.DESCENDING];
		/**
		 * @private
		...
		protected var removeNodes:Set = new Set();
		// Вспомогательная пустая нода, используется при удалении нод из дерева
		protected var dummyNode:BSPNode = new BSPNode();
