package alternativa.engine3d.loaders {
	 ...
	 * материал WireMaterial с линиями серого цвета.
	 * </ul>
	 * 
	...
	public class Loader3DS extends EventDispatcher {
		...
		/**
		 * Загрузка сцены из 3DS-файла по указанному адресу. По окончании загрузки посылается сообщение <code>Event.COMPLETE</code>,
