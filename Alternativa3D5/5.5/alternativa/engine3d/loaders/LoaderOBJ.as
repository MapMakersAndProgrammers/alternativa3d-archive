package alternativa.engine3d.loaders {
	 ...
	 * модели помещаются в один контейнер <code>Object3D</code>. Отдельные модели в файле должны определяться командой
	 * <code>o&nbsp;object_name</code>.
	 * <p>
	 ...
	 *   <td>Выполняется загрузка файлов и формирование библиотеки материалов. Для текстурных материалов может быть указана
	 ...
	 *     размеров диффузной текстуры, то карта прозрачности сжимается или растягивается до размеров диффузной текстуры.</td>
	 * </tr>
	 * </table>
	 */
	public class LoaderOBJ extends EventDispatcher {
		 ...
		 * после чего контейнер с загруженными объектами становится доступным через свойство <code>content</code>. При вызове метода текущая
