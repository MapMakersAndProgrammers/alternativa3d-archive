package alternativa.engine3d.primitives {
	...
	import alternativa.engine3d.objects.FillMesh;

	use namespace alternativa3d;
	
	public class FillBox extends FillMesh {
		
		public function FillBox(width:Number = 100, length:Number = 100, height:Number = 100, widthSegments:uint = 1, lengthSegments:uint = 1, heightSegments:uint = 1, reverse:Boolean = false) {
