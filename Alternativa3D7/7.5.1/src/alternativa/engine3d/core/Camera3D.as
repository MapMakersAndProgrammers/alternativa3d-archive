package alternativa.engine3d.core {
	...
	public class Camera3D extends Object3D {
		...
		public function projectGlobal(point:Vector3D):Vector3D {
			...
			viewSizeX = view._width*0.5;
			viewSizeY = view._height*0.5;
			res.x = res.x*viewSizeX/res.z + viewSizeX;
			res.y = res.y*viewSizeY/res.z + viewSizeY;
			return res;
		}
		...
		public function calculateRay(origin:Vector3D, direction:Vector3D, viewX:Number, viewY:Number):void {
			...
			var dx:Number = viewX*focalLength/viewSizeX;
			var dy:Number = viewY*focalLength/viewSizeY;
		...
		override alternativa3d function composeMatrix():void {
			var vx:Number = viewSizeX/focalLength;
			var vy:Number = viewSizeY/focalLength;
