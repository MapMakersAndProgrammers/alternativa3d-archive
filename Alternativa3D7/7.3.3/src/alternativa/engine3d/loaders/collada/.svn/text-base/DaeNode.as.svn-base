					...
					if (animatedSkinAndJoints != null) {
						...
						if (animatedSkin.animation != null) {
							...
							if (animatedSkinAndJoints.animation != null) {
								for (var a:int = 0, numAnimations:int = animatedSkinAndJoints.animation.numAnimations; a < numAnimations; a++) {
									animatedSkin.animation.addAnimation(animatedSkinAndJoints.animation.getAnimationAt(a));
								}
							}
						} else {
