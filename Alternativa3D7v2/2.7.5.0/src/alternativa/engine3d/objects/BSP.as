package alternativa.engine3d.objects {
	...
	public class BSP extends Object3D {
		...
		override public function clone():Object3D {
			var bsp:BSP = new BSP();
			bsp.cloneBaseProperties(this);
			bsp.clipping = clipping;
			bsp.threshold = threshold;
			bsp.splitAnalysis = splitAnalysis;
			// Клонирование вершин
			var vertex:Vertex;
			var lastVertex:Vertex;
			for (vertex = vertexList; vertex != null; vertex = vertex.next) {
