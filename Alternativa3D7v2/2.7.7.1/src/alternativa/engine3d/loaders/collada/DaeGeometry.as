package alternativa.engine3d.loaders.collada {
	...
	public class DaeGeometry extends DaeElement {
		...
		public function get isSplitter():Boolean {
			var isSplitterXML:XML = data.mesh.extra.technique.(@profile == "Alternativa3D").mesh.splitter[0];
			if (isSplitterXML != null) {
				var value:String = isSplitterXML.toString();
				return (value == "true" || parseInt(value) != 0);
			}
			return false;
		}
		
		public function get isBaseGeometry():Boolean {
			var isBaseGeometryXML:XML = data.mesh.extra.technique.(@profile == "Alternativa3D").mesh.baseGeometry[0];
			if (isBaseGeometryXML != null) {
				var value:String = isBaseGeometryXML.toString();
				return (value == "true" || parseInt(value) != 0);
			}
			return false;
		}
