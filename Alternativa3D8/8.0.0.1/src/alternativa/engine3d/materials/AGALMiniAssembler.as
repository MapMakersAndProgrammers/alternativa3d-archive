...
package alternativa.engine3d.materials
{
	...
	public class AGALMiniAssembler
	{
		...
		{ 
			...
			agalcode.writeUnsignedInt( 0x1 );		// AGAL version, big endien, bit pattern will be 0x01000000
		...
		static private function init():void
		{
			...
			OPMAP[ KIL ] = new OpCode( KIL, 0, 0x27, OP_FRAG_ONLY );
			...
			REGMAP[ VT ]	= new Register( VT,	"vertex temporary",		0x2,	15,		REG_VERT | REG_WRITE | REG_READ );
