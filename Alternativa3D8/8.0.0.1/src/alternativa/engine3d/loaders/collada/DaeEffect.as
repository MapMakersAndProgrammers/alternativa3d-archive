package alternativa.engine3d.loaders.collada {
	...
	public class DaeEffect extends DaeElement {
		...
		public function getMaterial(setparams:Object):Material {
			...
			if (bump != null) {
				var bumpImage:DaeImage = bump.getImage(setparams);
				if (bumpImage != null) {
			...
			if (diffuse != null) {
				...
				if (color != null) {
					...
					fillMaterial.normalMapURL = bumpURL;
					fillMaterial.emissionMapURL = emissionURL;
					fillMaterial.specularMapURL = specularURL;
					return fillMaterial;
				} else {
					...
					if (image != null) {
						...
						textureMaterial.normalMapURL = bumpURL;
						textureMaterial.emissionMapURL = emissionURL;
						textureMaterial.specularMapURL = specularURL;
