		...
		private function parseMaterials(materials:Object, baseURL:String):void {
			...
			if (baseURL != null) {
				...
				for each (mat in this.materials) {
					if (mat.normalMapURL != null) {
						mat.normalMapURL = resolveURL(fixURL(mat.normalMapURL), base);
					}
					if (mat.specularMapURL != null) {
						mat.specularMapURL = resolveURL(fixURL(mat.specularMapURL), base);
					}
					if (mat.emissionMapURL != null) {
						mat.emissionMapURL = resolveURL(fixURL(mat.emissionMapURL), base);
					}
				}
			} else {
				for each (tmaterial in textureMaterials) {
				...
				for each (mat in this.materials) {
					if (mat.normalMapURL != null) {
						mat.normalMapURL = fixURL(mat.normalMapURL);
					}
					if (mat.specularMapURL != null) {
						mat.specularMapURL = fixURL(mat.specularMapURL);
					}
					if (mat.emissionMapURL != null) {
						mat.emissionMapURL = fixURL(mat.emissionMapURL);
					}
				}
			}
		}
